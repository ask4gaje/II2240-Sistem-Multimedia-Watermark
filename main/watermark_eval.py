...
def main():
    ...
    img_path = os.path.join(project_root, 'assets', 'test_image.jpg')
    ...
    for i, qf in enumerate(qf_values):
        ...
        wm_output_path = os.path.join(result_dir, f'extracted_qf{qf}.png')
        
        # Save the file to disk
        cv2.imwrite(output_path, watermarked_img, [int(cv2.IMWRITE_JPEG_QUALITY), qf])
        ...
        # Save the extracted watermark to the result folder
        cv2.imwrite(wm_output_path, extracted_wm)
